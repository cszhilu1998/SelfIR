...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--crpp_patch', type=int, default=48)
        parser.add_argument('--blur_loss', type=float, default=1)
        ...
        parser.add_argument("--noisetype", type=str, default="gauss")
